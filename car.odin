...
game_update :: proc(dt: f32) {
	...
	if rd.walker {
		...
		// gait_ph in bodyfx.glsl: feet plant when it holds, freeze at a standstill.
		kg := min(5.0 / pr, 0.22)
	...
	// physics.comp applies the burn and ship() (ship.frag) draws it, all off this one envelope
	held := false
